...
#define NO_SYNCPOINT_LONG_NAME   "--noSyncPoint"
#define NO_SYNCPOINT_SHORT_NAME   "-np"
#define NO_SUBSCRIPTIONS_LONG_NAME   "--noSubscriptions"
#define NO_SUBSCRIPTIONS_SHORT_NAME   "-ns"
