/*===========================================================================*/
/*              This supportpac is maintained by Geoff Winn                  */
/*                                                                           */
/*              Jeff Lowrey is maintainer emeritus.                          */
...
/*(C)Copyright IBM Corporation 2007, 2008, 2009, 2011                        */
/*                                                                           */
/*===========================================================================*/
/*                                                                           */
                    ...
                    int isClient)
{
   ...
   /* Loop through the command line switches and parameters.                  */
   while (argc > *ParmCount && !inValidParm)
   {
      ...
      /************************************************************************/
      /* Check for queue manager name. [ --localQMgr | -m ]                   */
      /************************************************************************/
      if ((memcmp(argv[*ParmCount],
                  LOCAL_QMGR_SHORT_NAME,
                  strlen(LOCAL_QMGR_SHORT_NAME)) == 0) ||
          (memcmp(argv[*ParmCount],
                  LOCAL_QMGR_LONG_NAME,
                  strlen(LOCAL_QMGR_LONG_NAME)) == 0))
      {
         ...
         else
         {
            ...
            {
               strncpy(MyParms->LclQMgrName,
                       argv[*ParmCount] + strlen(LOCAL_QMGR_LONG_NAME),
                       MQ_Q_MGR_NAME_LENGTH);
               *ParmCount += 1;
            }
            else
            {
               strncpy(MyParms->LclQMgrName,
                       argv[*ParmCount] + strlen(LOCAL_QMGR_SHORT_NAME),
                       MQ_Q_MGR_NAME_LENGTH);
               *ParmCount += 1;
            }
            if (MyParms->diagnostics > 20)
      ...
      /************************************************************************/
      /* Check for remote queue manager name. [ --remoteQMgr | -r ]           */
      /************************************************************************/
      if ((memcmp(argv[*ParmCount],
                  REMOTE_QMGR_SHORT_NAME,
                  strlen(REMOTE_QMGR_SHORT_NAME)) == 0) ||
          (memcmp(argv[*ParmCount],
                  REMOTE_QMGR_LONG_NAME,
                  strlen(REMOTE_QMGR_LONG_NAME)) == 0))
      {
         ...
         if (strlen(argv[*ParmCount]) == strlen(REMOTE_QMGR_SHORT_NAME) ||
             strlen(argv[*ParmCount]) == strlen(REMOTE_QMGR_LONG_NAME))
         {
            if (*ParmCount < (argc - 1))
            {
               strncpy(MyParms->RmtQMgrName,
                       argv[*ParmCount + 1],
                       MQ_Q_MGR_NAME_LENGTH);
               *ParmCount += 2;
               if (MyParms->diagnostics > 20)
         ...
         else
         {
            ...
            {
               strncpy(MyParms->RmtQMgrName,
                       argv[*ParmCount] + strlen(REMOTE_QMGR_LONG_NAME),
                       MQ_Q_MGR_NAME_LENGTH);
               *ParmCount += 1;
            }
            else
            {
               strncpy(MyParms->RmtQMgrName,
                       argv[*ParmCount] + strlen(REMOTE_QMGR_SHORT_NAME),
                       MQ_Q_MGR_NAME_LENGTH);
               *ParmCount += 1;
            }
            if (MyParms->diagnostics > 20)
      ...
      /************************************************************************/
      /* Check for command server queue name. [ --commandServerQ | -cs ]      */
      /************************************************************************/
      if (memcmp(argv[*ParmCount],
                 COMSVRQ_SHORT_NAME,
                 strlen(COMSVRQ_SHORT_NAME)) == 0 ||
          memcmp(argv[*ParmCount],
                 COMSVRQ_LONG_NAME,
                 strlen(COMSVRQ_LONG_NAME)) == 0)
      {
             ...
             strlen(argv[*ParmCount]) != strlen(COMSVRQ_LONG_NAME))
         {
            if (memcmp(argv[*ParmCount],
                       ...
                       strlen(COMSVRQ_LONG_NAME)) == 0)
            {
               strncpy(MyParms->CmdSvrQName,
                       argv[*ParmCount] + strlen(COMSVRQ_LONG_NAME),
            ...
            {
               strncpy(MyParms->CmdSvrQName,
                       argv[*ParmCount] + strlen(COMSVRQ_SHORT_NAME),
                       sizeof(MyParms->CmdSvrQName));
               *ParmCount += 1;
            }
            if (MyParms->diagnostics > 20)
                  ...
                  strlen(VERSION_LONG_NAME)) == 0 ))
      {
             ...
             (strlen(argv[*ParmCount]) != strlen(VERSION_LONG_NAME)))
         {
            if (memcmp(argv[*ParmCount],
                       ...
                       strlen(VERSION_LONG_NAME)) == 0)
            {
               MyParms->UserVersion = atoi(argv[*ParmCount] + strlen(VERSION_LONG_NAME));
               strcpy(MyParms->StrVersion,
                      argv[*ParmCount] + strlen(VERSION_LONG_NAME));
               *ParmCount += 1;
            }
            else
            {
               MyParms->UserVersion = atoi(argv[*ParmCount] + strlen(VERSION_SHORT_NAME));
               strcpy(MyParms->StrVersion,
                      argv[*ParmCount] + strlen(VERSION_SHORT_NAME));
               *ParmCount += 1;
            }
            if (MyParms->diagnostics > 20)
            {
      ...
      if ((memcmp(argv[*ParmCount],
                  OUTPUT_FILE_SHORT_NAME,
                  strlen(OUTPUT_FILE_SHORT_NAME)) == 0 ) ||
          (memcmp(argv[*ParmCount],
                  OUTPUT_FILE_LONG_NAME,
                  strlen(OUTPUT_FILE_LONG_NAME)) == 0 ) ||
          (memcmp(argv[*ParmCount],
                  OUTPUT_FILE_NH_SHORT_NAME,
                  strlen(OUTPUT_FILE_NH_SHORT_NAME)) == 0 ) ||
          (memcmp(argv[*ParmCount],
                  OUTPUT_FILE_NH_LONG_NAME,
                  strlen(OUTPUT_FILE_NH_LONG_NAME)) == 0 ))
      {
         ...
         if (strlen(argv[*ParmCount]) != strlen(OUTPUT_FILE_LONG_NAME) &&
             strlen(argv[*ParmCount]) != strlen(OUTPUT_FILE_SHORT_NAME) &&
             strlen(argv[*ParmCount]) != strlen(OUTPUT_FILE_NH_SHORT_NAME) &&
             strlen(argv[*ParmCount]) != strlen(OUTPUT_FILE_NH_LONG_NAME))
         {
            if (memcmp(argv[*ParmCount],
                       OUTPUT_FILE_LONG_NAME,
                       strlen(OUTPUT_FILE_LONG_NAME)) == 0)
            {
               strncpy(MyParms->fileName,
                       argv[*ParmCount] + strlen(OUTPUT_FILE_LONG_NAME),
                       FILENAMESIZE);
            }
            else
            {
               ...
               {
                  strncpy(MyParms->fileName,
                          argv[*ParmCount] + strlen(OUTPUT_FILE_NH_LONG_NAME),
                          FILENAMESIZE);
               }
               else
               {
         ...
         {
            if ((*ParmCount + 1) < argc &&
                argv[*ParmCount + 1][0] != '-') /* is the next token not a switch ? */
            {
      ...
      if (memcmp(argv[*ParmCount],
                 SAVE_SEC_SHORT_NAME,
                 strlen(SAVE_SEC_SHORT_NAME)) == 0 ||
          memcmp(argv[*ParmCount],
                 SAVE_SEC_NH_SHORT_NAME,
                 strlen(SAVE_SEC_NH_SHORT_NAME)) == 0 ||
          memcmp(argv[*ParmCount],
                 SAVE_SEC_LONG_NAME,
                 strlen(SAVE_SEC_LONG_NAME)) == 0 ||
          memcmp(argv[*ParmCount],
                 SAVE_SEC_NH_LONG_NAME,
                 strlen(SAVE_SEC_NH_LONG_NAME)) == 0)
      {
         ...
         if (strlen(argv[*ParmCount]) != strlen(SAVE_SEC_LONG_NAME) &&
             ...
             strlen(argv[*ParmCount]) != strlen(SAVE_SEC_NH_SHORT_NAME) &&
             strlen(argv[*ParmCount]) != strlen(SAVE_SEC_NH_LONG_NAME))
         {
            if (memcmp(argv[*ParmCount],
                       SAVE_SEC_LONG_NAME,
                       strlen(SAVE_SEC_LONG_NAME)) == 0)
            {
               strncpy(MyParms->authFileName,
                       argv[*ParmCount] + strlen(SAVE_SEC_LONG_NAME),
                       FILENAMESIZE);
            }
            else
               if (memcmp(argv[*ParmCount],
               ...
               {
                  strncpy(MyParms->authFileName,
                          argv[*ParmCount] + strlen(SAVE_SEC_NH_LONG_NAME),
                          FILENAMESIZE);
               }
               else
               {
      ...
      if (memcmp(argv[*ParmCount],
                 STDOUT_SHORT_NAME,
                 strlen(STDOUT_SHORT_NAME)) == 0 ||
          memcmp(argv[*ParmCount],
                 STDOUT_LONG_NAME,
                 strlen(STDOUT_LONG_NAME)) == 0)
      {
      ...
      if (memcmp(argv[*ParmCount],
                 NO_SYNCPOINT_SHORT_NAME,
                 strlen(NO_SYNCPOINT_SHORT_NAME)) == 0 ||
          memcmp(argv[*ParmCount],
                 NO_SYNCPOINT_LONG_NAME,
                 strlen(NO_SYNCPOINT_LONG_NAME)) == 0)
      {
         MyParms->noSyncPoint = 1;
         if (MyParms->diagnostics > 20)
         {
            fprintf(stderr,
                    "(args.c) Processing %s flag, setting flag to not use syncpoint \n",
                    NO_SYNCPOINT_SHORT_NAME);
         }
         *ParmCount += 1;
         continue;
      ...
      if (memcmp(argv[*ParmCount],
                 NO_SUBSCRIPTIONS_SHORT_NAME,
                 strlen(NO_SUBSCRIPTIONS_SHORT_NAME)) == 0 ||
          memcmp(argv[*ParmCount],
                 NO_SUBSCRIPTIONS_LONG_NAME,
                 strlen(NO_SUBSCRIPTIONS_LONG_NAME)) == 0)
      {
         MyParms->noSubscriptions = 1;
         if (MyParms->diagnostics > 20)
         {
            fprintf(stderr,
                    "(args.c) Processing %s flag, setting flag to not save subscriptions \n",
                    NO_SUBSCRIPTIONS_SHORT_NAME);
         }
         *ParmCount += 1;
         continue;
      ...
      if (memcmp(argv[*ParmCount],
                 NO_SYSOBJS_SHORT_NAME,
                 strlen(NO_SYSOBJS_SHORT_NAME)) == 0 ||
          memcmp(argv[*ParmCount],
                 NO_SYSOBJS_LONG_NAME,
                 NO_SYSOBJS_LONG_LN) == 0)
      {
         ...
         while (found != NULL)
         {
            ...
            if (!strcmp(found, "QMGR"))
            {
               ...
               if (!strcmp(found, "QUEUE"))
               {
                  MyParms->SysObjs |= SO_QUEUE;
               }
               else
                  if (!strcmp(found, "NAMELIST"))
                  {
                     MyParms->SysObjs |= SO_NAMELIST;
                  }
                  else
                     if (!strcmp(found, "PROCESS"))
                     {
                        MyParms->SysObjs |= SO_PROCESS;
                     }
                     else
                        if (!strcmp(found, "AUTHINFO"))
                        {
                           MyParms->SysObjs |= SO_AUTHINFO;
                        } 
                        else
                           if (!strcmp(found, "LISTENER"))
                           {
                              MyParms->SysObjs |= SO_LISTENER;
                           }
                           else
                              if (!strcmp(found, "CHANNEL"))
                              {
                                 MyParms->SysObjs |= SO_CHANNEL;
                              }
                              else
                                 if (!strcmp(found, "SERVICE"))
                                 {
                                    MyParms->SysObjs |= SO_SERVICE;
                                 }
                                 else
                                    if (!strcmp(found, "TOPIC"))
                                    {
      ...
      if (memcmp(argv[*ParmCount],
                 DIAG_SHORT_NAME,
                 strlen(DIAG_SHORT_NAME)) == 0 ||
          memcmp(argv[*ParmCount],
                 DIAG_LONG_NAME,
                 strlen(DIAG_LONG_NAME)) == 0)
      {
         MyParms->diagnostics = 1; /* default to 1 if not specified */
         /* test to see if there is a blank after the flag */
         ...
         *ParmCount += 1;
         if (*ParmCount < argc && /* is the next token not a switch ? */
             argv[*ParmCount][0] != '-')
         {
                 ...
                 strlen(HOSTNAME_LONG_NAME)) == 0)
      {
             ...
             strlen(argv[*ParmCount]) != strlen(HOSTNAME_LONG_NAME))
         {
            if (memcmp(argv[*ParmCount],
                       ...
                       strlen(HOSTNAME_LONG_NAME)) == 0)
            {
               strncpy(MyParms->argCONNAME,
                       argv[*ParmCount] + strlen(HOSTNAME_LONG_NAME),
                       MQ_CONN_NAME_LENGTH);
               *ParmCount += 1;
            }
            else
                 ...
                 strlen(CHANNEL_LONG_NAME)) == 0)
      {
             ...
             strlen(argv[*ParmCount]) != strlen(CHANNEL_LONG_NAME))
         {
            if (memcmp(argv[*ParmCount],
                       ...
                       strlen(CHANNEL_LONG_NAME)) == 0)
            {
               strncpy(MyParms->argSVRCONN,
                       argv[*ParmCount] + strlen(CHANNEL_LONG_NAME),
      ...
      if (memcmp(argv[*ParmCount],
                 SSL_CIPHER_SHORT_NAME,
                 strlen(SSL_CIPHER_SHORT_NAME)) == 0 ||
          memcmp(argv[*ParmCount],
                 SSL_CIPHER_LONG_NAME,
             ...
             strlen(argv[*ParmCount]) != strlen(SSL_CIPHER_LONG_NAME))
         {
                       ...
                       strlen(SSL_CIPHER_LONG_NAME)) == 0)
            {
               strncpy(MyParms->ClientConn.SSLCipherSpec,
                       argv[*ParmCount] + sizeof(SSL_CIPHER_LONG_NAME),
                       sizeof(MyParms->SSL_options.KeyRepository));
            }
            else
            {
      ...
      if (memcmp(argv[*ParmCount],
                 CHANNEL_EXIT_Y_SHORT_NAME,
                 strlen(CHANNEL_EXIT_Y_SHORT_NAME)) == 0 ||
          memcmp(argv[*ParmCount],
                 CHANNEL_EXIT_Y_LONG_NAME,
                 strlen(CHANNEL_EXIT_Y_LONG_NAME)) == 0)
      {
         ...
         if (strlen(argv[*ParmCount]) != strlen(CHANNEL_EXIT_Y_SHORT_NAME) &&
             strlen(argv[*ParmCount]) != strlen(CHANNEL_EXIT_Y_LONG_NAME))
         {
            if (memcmp(argv[*ParmCount],
                       CHANNEL_EXIT_Y_LONG_NAME,
                       strlen(CHANNEL_EXIT_Y_LONG_NAME)) == 0)
            {
               strncpy(MyParms->ClientConn.SecurityExit,
                       argv[*ParmCount] + strlen(CHANNEL_EXIT_Y_LONG_NAME),
            ...
            if (MyParms->diagnostics > 20)
            {
               fprintf(stderr,
                       ...
                       CHANNEL_EXIT_Y_SHORT_NAME,
                       MyParms->ClientConn.SecurityExit);
            }
         }
         else
         {
      ...
      if (memcmp(argv[*ParmCount],
                 CHANNEL_EXIT_S_SHORT_NAME,
                 strlen(CHANNEL_EXIT_S_SHORT_NAME)) == 0 ||
          memcmp(argv[*ParmCount],
                 CHANNEL_EXIT_S_LONG_NAME,
                 strlen(CHANNEL_EXIT_S_LONG_NAME)) == 0)
      {
         ...
         if (strlen(argv[*ParmCount]) != strlen(CHANNEL_EXIT_S_SHORT_NAME) &&
             strlen(argv[*ParmCount]) != strlen(CHANNEL_EXIT_S_LONG_NAME))
         {
            if (memcmp(argv[*ParmCount],
                       CHANNEL_EXIT_S_LONG_NAME,
                       strlen(CHANNEL_EXIT_S_LONG_NAME)) == 0)
            {
               strncpy(MyParms->ClientConn.SendExit,
                       argv[*ParmCount] + strlen(CHANNEL_EXIT_S_LONG_NAME),
      ...
      if (memcmp(argv[*ParmCount],
                 CHANNEL_EXIT_R_SHORT_NAME,
                 strlen(CHANNEL_EXIT_R_SHORT_NAME)) == 0 ||
          memcmp(argv[*ParmCount],
                 CHANNEL_EXIT_R_LONG_NAME,
                 strlen(CHANNEL_EXIT_R_LONG_NAME)) == 0)
      {
         ...
         if ((strlen(argv[*ParmCount]) != strlen(CHANNEL_EXIT_R_SHORT_NAME)) &&
             (strlen(argv[*ParmCount]) != strlen(CHANNEL_EXIT_R_LONG_NAME)))
         {
            if (memcmp(argv[*ParmCount],
                       CHANNEL_EXIT_R_LONG_NAME,
                       strlen(CHANNEL_EXIT_R_LONG_NAME)) == 0)
            {
               strncpy(MyParms->ClientConn.ReceiveExit,
                       argv[*ParmCount] + strlen(CHANNEL_EXIT_R_LONG_NAME),
            ...
            if (MyParms->diagnostics > 20)
            {
               fprintf(stderr,
                       ...
                       CHANNEL_EXIT_R_SHORT_NAME,
                       MyParms->ClientConn.ReceiveExit);
            }
         }
         else
         {
      ...
      if (memcmp(argv[*ParmCount],
                 CHANNEL_DATA_Y_SHORT_NAME,
                 strlen(CHANNEL_DATA_Y_SHORT_NAME)) == 0 ||
          memcmp(argv[*ParmCount],
                 CHANNEL_DATA_Y_LONG_NAME,
                 strlen(CHANNEL_DATA_Y_LONG_NAME)) == 0)
      {
         ...
         if (strlen(argv[*ParmCount]) != strlen(CHANNEL_DATA_Y_SHORT_NAME) &&
             strlen(argv[*ParmCount]) != strlen(CHANNEL_DATA_Y_LONG_NAME))
         {
            if (memcmp(argv[*ParmCount],
                       CHANNEL_DATA_Y_LONG_NAME,
                       strlen(CHANNEL_DATA_Y_LONG_NAME)) == 0)
               ...
               *ParmCount += 2;
               if (MyParms->diagnostics > 20)
               {
                  fprintf(stderr,
                          "(args.c) Processing %s flag, setting Channel Security User Data to %s\n",
                          CHANNEL_DATA_Y_SHORT_NAME,
                          MyParms->ClientConn.SecurityUserData);
               }
            }
            else
            {
      ...
      if (memcmp(argv[*ParmCount],
                 CHANNEL_DATA_S_SHORT_NAME,
                 strlen(CHANNEL_DATA_S_SHORT_NAME)) == 0 ||
          memcmp(argv[*ParmCount],
                 CHANNEL_DATA_S_LONG_NAME,
                 strlen(CHANNEL_DATA_S_LONG_NAME)) == 0)
      {
         ...
         if (strlen(argv[*ParmCount]) != strlen(CHANNEL_DATA_S_SHORT_NAME) &&
             strlen(argv[*ParmCount]) != strlen(CHANNEL_DATA_S_LONG_NAME))
         {
            if (memcmp(argv[*ParmCount],
                       CHANNEL_DATA_S_LONG_NAME,
                       strlen(CHANNEL_DATA_S_LONG_NAME)) == 0)
            {
               strncpy(MyParms->ClientConn.SendUserData,
                       argv[*ParmCount] + strlen(CHANNEL_DATA_S_LONG_NAME),
            ...
            {
               fprintf(stderr,
                       "(args.c) Processing %s flag, setting Channel Send User Data to %s\n",
                       CHANNEL_DATA_S_SHORT_NAME,
                       MyParms->ClientConn.SendUserData);
            }
         }
         else
         {
      ...
      if (memcmp(argv[*ParmCount],
                 CHANNEL_DATA_R_SHORT_NAME,
                 strlen(CHANNEL_DATA_R_SHORT_NAME)) == 0 ||
          memcmp(argv[*ParmCount],
                 CHANNEL_DATA_R_LONG_NAME,
                 strlen(CHANNEL_DATA_R_LONG_NAME)) == 0)
      {
         ...
         if (strlen(argv[*ParmCount]) != strlen(CHANNEL_DATA_R_SHORT_NAME) &&
             strlen(argv[*ParmCount]) != strlen(CHANNEL_DATA_R_LONG_NAME))
         {
            if (memcmp(argv[*ParmCount],
                       CHANNEL_DATA_R_LONG_NAME,
                       strlen(CHANNEL_DATA_R_LONG_NAME)) == 0)
            ...
            {
               fprintf(stderr,
                       "(args.c) Processing %s flag, setting Channel Receive User Data to %s\n",
                       CHANNEL_DATA_R_SHORT_NAME,
                       MyParms->ClientConn.ReceiveUserData);
            }
         }
         else
         {
      ...
      if (memcmp(argv[*ParmCount],
                 ...
                 strlen(REPLACE_OUTPUT_SHORT_NAME)) == 0 ||
          memcmp(argv[*ParmCount],
                 REPLACE_OUTPUT_LONG_NAME,
                 strlen(REPLACE_OUTPUT_LONG_NAME)) == 0)
      {
         *ParmCount += 1;
         ...
         {
            fprintf(stderr,
                    "(args.c) Processing %s flag, setting Replace Output File to true\n",
                    REPLACE_OUTPUT_SHORT_NAME);
         }
         continue;
      }
      ...
      if (memcmp(argv[*ParmCount],
                 RESET_CHANNELS_SHORT_NAME,
                 strlen(RESET_CHANNELS_SHORT_NAME)) == 0 ||
          memcmp(argv[*ParmCount],
                 RESET_CHANNELS_LONG_NAME,
                 strlen(RESET_CHANNELS_LONG_NAME)) == 0)
      {
         ...
         if (strlen(argv[*ParmCount]) != strlen(RESET_CHANNELS_SHORT_NAME) &&
             strlen(argv[*ParmCount]) != strlen(RESET_CHANNELS_LONG_NAME))
         {
            if (memcmp(argv[*ParmCount],
                       RESET_CHANNELS_LONG_NAME,
                       strlen(RESET_CHANNELS_LONG_NAME)) == 0)
            {
               strncpy(MyParms->reset_Switches,
                       argv[*ParmCount] + (strlen(RESET_CHANNELS_LONG_NAME)),
                       sizeof(MyParms->reset_Switches));
               if (MyParms->diagnostics > 20)
               {
                  fprintf(stderr,
                          "(args.c) Processing %s flag, setting Reset Channels to %s\n",
                          RESET_CHANNELS_SHORT_NAME,
                          MyParms->reset_Switches);
               }
               *ParmCount += 1;
            }
            else
            ...
            if ((*ParmCount + 1) < argc && /* is the next token not a switch ? */
                argv[*ParmCount + 1][0] != '-')
            {
         ...
         {
            fprintf(stderr,
                    "(args.c) Processed %s flag, setting Channel Reset Flags to to %d\n",
                    RESET_CHANNELS_SHORT_NAME,
                    MyParms->chlReset);
         }
         continue;
      ...
      if (memcmp(argv[*ParmCount],
                 QUIET_SHORT_NAME,
                 strlen(QUIET_SHORT_NAME)) == 0 ||
          memcmp(argv[*ParmCount],
                 QUIET_LONG_NAME,
                 strlen(QUIET_LONG_NAME)) == 0)
      {
         MyParms->noisy = 0; /* user does NOT want warning msgs   */
         if (MyParms->diagnostics > 20)
         {
            fprintf(stderr,
                    "(args.c) Processing %s flag, setting noisy to false\n",
                    QUIET_SHORT_NAME);
         }
         *ParmCount += 1;
         continue;
      ...
      if (memcmp(argv[*ParmCount],
                 HELP_SHORT_NAME,
                 strlen(HELP_SHORT_NAME)) == 0 ||
          memcmp(argv[*ParmCount],
                 HELP_SHORT_NAME_ALT1,
                 strlen(HELP_SHORT_NAME_ALT1)) == 0 ||
          memcmp(argv[*ParmCount],
                 HELP_SHORT_NAME_ALT2,
                 strlen(HELP_SHORT_NAME_ALT2)) == 0 ||
          memcmp(argv[*ParmCount],
                 HELP_LONG_NAME,
                 strlen(HELP_LONG_NAME)) == 0)
      {
         if (isClient)
         {
            fprintf(stderr, USAGE, MyParms->myName, USAGE2);
      ...
      if (memcmp(argv[*ParmCount],
                 PERMDYN_SHORT_NAME,
                 strlen(PERMDYN_SHORT_NAME)) == 0 ||
          memcmp(argv[*ParmCount],
                 PERMDYN_LONG_NAME,
                 strlen(PERMDYN_LONG_NAME)) == 0)
      {
         MyParms->permDyn = 1; /* v530 user wants qlocals created from permdyn */
         if (MyParms->diagnostics > 20)
         {
            fprintf(stderr,
                    "(args.c) Processing %s flag, setting Create Permanent Dyanmic queues to true\n",
                    PERMDYN_SHORT_NAME);
         }
         *ParmCount += 1;
         continue;
      ...
      if (memcmp(argv[*ParmCount],
                 ...
                 strlen(IGNORE_ERRORS_SHORT_NAME)) == 0 ||
          memcmp(argv[*ParmCount],
                 IGNORE_ERRORS_LONG_NAME,
                 strlen(IGNORE_ERRORS_LONG_NAME)) == 0)
      {
         ...
         {
            fprintf(stderr,
                    "(args.c) Processing %s flag, setting Ignore Damaged queues to true\n",
                    IGNORE_ERRORS_SHORT_NAME);
         }
         *ParmCount += 1;
         continue;
      ...
      if (memcmp(argv[*ParmCount],
                 ONE_LINE_SHORT_NAME,
                 strlen(ONE_LINE_SHORT_NAME)) == 0 ||
          memcmp(argv[*ParmCount],
                 ONE_LINE_LONG_NAME,
                 strlen(ONE_LINE_LONG_NAME)) == 0)
      {
         ...
         {
            fprintf(stderr,
                    "(args.c) Processing %s flag, setting One Line to true\n",
                    ONE_LINE_SHORT_NAME);
         }
         *ParmCount += 1;
         continue;
      ...
      if (memcmp(argv[*ParmCount],
                 ...
                 strlen(TWO_LINES_SHORT_NAME)) == 0 ||
          memcmp(argv[*ParmCount],
                 TWO_LINES_LONG_NAME,
                 strlen(TWO_LINES_LONG_NAME)) == 0)
      {
         ...
         {
            fprintf(stderr,
                    "(args.c) Processing %s flag, setting Two Lines to true\n",
                    TWO_LINES_SHORT_NAME);
         }
         *ParmCount += 1;
         continue;
      ...
      if (memcmp(argv[*ParmCount],
                 OUTPUT_STYLE_MQSC_LONG_NAME,
                 strlen(OUTPUT_STYLE_MQSC_LONG_NAME)) == 0)
      {
                 ...
                 strlen(PLATFORM_LONG_NAME)) == 0)
      {
             ...
             strlen(argv[*ParmCount]) != strlen(PLATFORM_LONG_NAME))
         {
            if (memcmp(argv[*ParmCount],
                       ...
                       strlen(PLATFORM_LONG_NAME)) == 0)
            {
               platform = atoi(argv[*ParmCount] + strlen(PLATFORM_LONG_NAME));
            }
            else
            {
            ...
            {
               fprintf(stderr,
                       "(args.c) Processing %s flag, setting platform to %d\n",
                       PLATFORM_SHORT_NAME,
                       platform);
            }
         }
      ...
      if (memcmp(argv[*ParmCount],
                 SHORT_WAITTIME_SHORT_NAME,
                 strlen(SHORT_WAITTIME_SHORT_NAME)) == 0 ||
          memcmp(argv[*ParmCount],
                 SHORT_WAITTIME_LONG_NAME,
                 strlen(SHORT_WAITTIME_LONG_NAME)) == 0)
      {
         if (strlen(argv[*ParmCount]) == strlen(SHORT_WAITTIME_SHORT_NAME) ||
             strlen(argv[*ParmCount]) == strlen(SHORT_WAITTIME_LONG_NAME))
         {
            *ParmCount += 1;
            if (*ParmCount < argc && /* is the next token not a switch ? */
                argv[*ParmCount][0] != '-')
            ...
            if (strlen(argv[*ParmCount]) > strlen(SHORT_WAITTIME_LONG_NAME))
            {
               MyParms->shortWaitTime =
                  atoi(argv[*ParmCount] + strlen(SHORT_WAITTIME_LONG_NAME));
            }
            else
            {
               MyParms->shortWaitTime =
                  atoi(argv[*ParmCount] + strlen(SHORT_WAITTIME_SHORT_NAME));
            }
         if (MyParms->diagnostics > 20)
         {
            fprintf(stderr,
                    "(args.c) Processing %s flag, setting Short Wait time to %d\n",
                    SHORT_WAITTIME_SHORT_NAME,
                    MyParms->shortWaitTime);
         }
         *ParmCount += 1;
      ...
      if (memcmp(argv[*ParmCount],
                 WAITTIME_SHORT_NAME,
                 strlen(WAITTIME_SHORT_NAME)) == 0 ||
          memcmp(argv[*ParmCount],
                 WAITTIME_LONG_NAME,
                 strlen(WAITTIME_LONG_NAME))== 0)
      {
             ...
             strlen(argv[*ParmCount]) == strlen(WAITTIME_LONG_NAME))
         {
            *ParmCount += 1;
            ...
            if (strlen(argv[*ParmCount]) > strlen(WAITTIME_LONG_NAME))
            {
               MyParms->longWaitTime =
                  atoi(argv[*ParmCount] + strlen(WAITTIME_LONG_NAME)) * 1000;
            }
            else
            {
               MyParms->longWaitTime =
                  atoi(argv[*ParmCount] + strlen(WAITTIME_SHORT_NAME)) * 1000;
            }
         if (MyParms->diagnostics > 20)
         {
            fprintf(stderr,
                    "(args.c) Processing %s flag, setting Long Wait time to %d\n",
                    SHORT_WAITTIME_SHORT_NAME,
                    MyParms->longWaitTime);
         }
         *ParmCount += 1;
...
int ProcessISeriesArgs(int argc,
                       char *argv[],
                       CmdArgParmsPtr MyParms,
                       int *ParmCount)
{
   ...
   {
      fprintf(stderr,
              "(saveqmgr.c) Incorrect number of parameters.\n");
      fprintf(stderr,
              "(saveqmgr.c) Should be %d, received %d\n\n",
              OS400PARMCNT,
              argc);
      inValidParm = 1;
      exit(ERROR);
...
void InitArgs(CmdArgParmsPtr MyParms)
{
   ...
   MyParms->noSyncPoint = 0;
   MyParms->noSubscriptions = 0;
}
