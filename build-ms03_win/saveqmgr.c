				...
				case MQCMD_INQUIRE_TOPIC:
					...
					break;
                                case MQCMD_INQUIRE_SUBSCRIPTION:
                                        fflush(*poutputfp);
                                        /* Only write if name is NOT "SYSTEM." or user wants them */
                                        if (printThisObject(pSubscriptDefn->SubscrName,
                                                            SysObjs,
                                                            SO_SUB))
                                        {
                                           /* if (memcmp(SubscriptDefn.SubscrName, */
                                           /*            "SYSTEM.", 7) || */
                                           ...
                                           if (firstSubscript)
                                           {
                                              ...
                                              {
                                                 fprintf(stderr,
                                                         "Omitting subscription definitions (--noSubscriptions specified).\n");
                                              }
                                           }

                                           if (pMyParms->noSubscriptions == 0)
                                           {
                                              AddToFileSubscr(pSubscriptDefn,
                                                              *pUserVersion,
                                                              fileName,
                                                              *poutputfp,
                                                              0,
                                        ...
                                        else
                                        {
                                           if (firstSubscript > 1)
                                           {
                                              fputs("** (Skipping SYSTEM Subscription objects) **\n",
                                                    *poutputfp);
                                              firstSubscript--;
                                           }
                                        }
